...
gw2_strings =
{
    ["en"] =
    {
		...
		smSwitchSettings				= "Switch Settings",
		smSkillList						= "Skill List",
		smSkill							= "Skill",
		smSkillID						= "Skill ID",
		smSetRange						= "Set Range",
		smRadius						= "Radius",
		smSlowCast						= "Slow Cast",
		smDelay							= "Skill Delay (ms)",
		smPlayer						= "Player",
		smCondCount						= "Condition Count",
		smBoonCount						= "Boon Count",
		smMoveUp						= "Move Skill Up",
		smMoveDown						= "Move Skill Down",
		smClone							= "Clone Skill",
		smCopy							= "Copy Skill",
		smPaste							= "Paste Skill",
...
--vendorManager
		...
		mbwarning						= "Start MultibotServer.exe or press OK to disable Multibotting",
		--mc_followbot
    ...
    addblock                        = "Add Block",
		...
		minionmode						= "Minion模式",
		mbwarning						= "打开MultibotServer.exe或按一下ok关闭组队",
		--mc_followbot
		followmode						= "跟随模式",
		followtarget					= "跟随目标",
		--mc_main.lua
    ...
    TargetCastingTime           = "Casting Time >",
		...
		taskSetupTasks					= "Setup Tasks",
		taskCurrentTask					= "Current Task",
		taskAddTask						= "Neue Task",
		taskNewTaskProfile				= "Neues Profile",
		taskStartConditions				= "Start Konditionen",
		taskCustomConditions			= "Custom Konditionen",
		taskType						= "Type",
		taskPreTaskIDsComplete			= "PreTaskID Completed",
		taskStartMapID					= "Start MapID",
		taskStartMapPos					= "Start MapPosition",
		...
		taskMaxDuration					= "Max Task Dauer (s)",
		taskCoolDownDuration			= "Task Cooldown (s)",
		taskPartySize					= "Min PartySize",

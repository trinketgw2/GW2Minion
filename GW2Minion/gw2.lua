...
function gw2minion.Init()
	...
	if ( ml_mesh_mgr ) then 
		...
		ml_mesh_mgr.SetDefaultMesh(32,"Diessa Plateau")
		ml_mesh_mgr.SetDefaultMesh(34,"Caledon Forest")
		ml_mesh_mgr.SetDefaultMesh(35,"Metrica Province")
		ml_mesh_mgr.SetDefaultMesh(39,"Mount Maelstrom")
		...
		ml_mesh_mgr.SetDefaultMesh(65,"Malchor's Leap")
		ml_mesh_mgr.SetDefaultMesh(73,"Bloodtide Coast")
		
		-- Lions Arch
		ml_mesh_mgr.SetDefaultMesh(50,"Lion's Arch")
		-- Black Citadel
		ml_mesh_mgr.SetDefaultMesh(218,"Black Citadel")
		ml_mesh_mgr.SetDefaultMesh(371,"Hero's Canton (Home)")
		...
		ml_mesh_mgr.SetDefaultMesh(968,"Edge of the Mists")
		
		--LS2
		ml_mesh_mgr.SetDefaultMesh(988,"Dry Top")
		ml_mesh_mgr.SetDefaultMesh(1015,"The Silverwastes")
		
		--HoT
		ml_mesh_mgr.SetDefaultMesh(1052,"Verdant Brink")
		ml_mesh_mgr.SetDefaultMesh(1043,"Auric Basin")
		ml_mesh_mgr.SetDefaultMesh(1041,"Dragon's Stand")
		ml_mesh_mgr.SetDefaultMesh(1045,"Tangled Depths")
		ml_mesh_mgr.SetDefaultMesh(1155,"Lion's Arch Aerodrome")
		...
		ml_mesh_mgr.SetDefaultMesh(1178,"Bitterfrost Frontier")
		...
		--Instances
		ml_mesh_mgr.SetDefaultMesh(896,"North Nolan Hatchery") -- Diessa Plateau
		ml_mesh_mgr.SetDefaultMesh(866,"Mad King's Labyrinth")
		ml_mesh_mgr.SetDefaultMesh(881,"Bell Choir Ensemble")

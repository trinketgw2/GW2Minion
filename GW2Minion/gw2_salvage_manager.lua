		...
		if (gw2_salvage_manager.mainWindow.visible) then
			...
			if (GUI:TreeNode(GetString("filters"))) then -- create the tree, only pop inside if.
				...
				if (GUI:BeginPopup("##msalvagem-filterPopup")) then
					...
					gw2_salvage_manager.tempFilter.itemType.Armor = GUI:Checkbox(GetString("Armor"),gw2_salvage_manager.tempFilter.itemType.Armor)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.Back = GUI:Checkbox(GetString("Back"),gw2_salvage_manager.tempFilter.itemType.Back)
					gw2_salvage_manager.tempFilter.itemType.Bag = GUI:Checkbox(GetString("Bag"),gw2_salvage_manager.tempFilter.itemType.Bag)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.Consumable = GUI:Checkbox(GetString("Consumable"),gw2_salvage_manager.tempFilter.itemType.Consumable)
					gw2_salvage_manager.tempFilter.itemType.CraftingMaterial = GUI:Checkbox(GetString("Crafting-Material"),gw2_salvage_manager.tempFilter.itemType.CraftingMaterial)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.Gathering = GUI:Checkbox(GetString("Gathering"),gw2_salvage_manager.tempFilter.itemType.Gathering)
					gw2_salvage_manager.tempFilter.itemType.Gizmo = GUI:Checkbox(GetString("Gizmo"),gw2_salvage_manager.tempFilter.itemType.Gizmo)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.MiniDeck = GUI:Checkbox(GetString("MiniDeck"),gw2_salvage_manager.tempFilter.itemType.MiniDeck)
					gw2_salvage_manager.tempFilter.itemType.SalvageTool = GUI:Checkbox(GetString("Salvage-Tool"),gw2_salvage_manager.tempFilter.itemType.SalvageTool)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.Trinket = GUI:Checkbox(GetString("Trinket"),gw2_salvage_manager.tempFilter.itemType.Trinket)
					gw2_salvage_manager.tempFilter.itemType.UpgradeComponent = GUI:Checkbox(GetString("Upgrade-Component"),gw2_salvage_manager.tempFilter.itemType.UpgradeComponent)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.Weapon = GUI:Checkbox(GetString("Weapon"),gw2_salvage_manager.tempFilter.itemType.Weapon)
					gw2_salvage_manager.tempFilter.itemType.Container = GUI:Checkbox(GetString("Container"),gw2_salvage_manager.tempFilter.itemType.Container)
					GUI:SameLine(155)
					gw2_salvage_manager.tempFilter.itemType.Trophy = GUI:Checkbox(GetString("Trophy"),gw2_salvage_manager.tempFilter.itemType.Trophy)
					GUI:EndChild()
					-- Layout spacing.
					GUI:Spacing()
					-----------------------------------------------------------------------------------------------------------------------------------
...
function gw2_salvage_manager.salvage()
	if (gw2_salvage_manager.active and ml_global_information.Player_Inventory_SlotsFree >= 2 and ml_global_information.Player_Alive and gw2_salvage_manager.checkCustomChecks()) then
